...
import com.ofsystem.Capstone.Mapper.IProductoMapper;
import com.ofsystem.Capstone.Model.Producto.Producto;
import com.ofsystem.Capstone.Service.Imple.CRUDServiceImpl;
import com.ofsystem.Capstone.Service.Service.Producto.IProductoService;
import com.ofsystem.Capstone.Repo.Producto.IProductoRepo;
...
public class ProductoServiceImpl extends CRUDServiceImpl<Producto, Integer> implements IProductoService {
	...
	@Override
	public List<Producto> findProductoByIsExistenteIsTrue() {
		return repo.findProductoByIsExistenteIsTrue();
	}
}
